...
png("LD_decay.png", height=1500, width=1500, res=300)
mar.default <- c(5,4,4,2) + 0.1
par(mar = mar.default + c(0, 4, 0, 0)) 

# Can plot all points in PNG (raster format handles this better)
plot(file$dist, file$rsq, pch=".", cex=2, 
     xlab="Distance (bp)", ylab=expression(LD ~ (r^2)), col="grey")
lines(newfile$file.dist, newfile$newrsq, col="red", lwd=2)
abline(h=0.1, col="blue")
abline(v=halfdecaydist, col="green")
mtext(round(halfdecaydist,2), side=1, line=0.05, at=halfdecaydist, 
      cex=0.75, col="green")
...
mtext(round(halfdecaydist, 2), side = 1, line = 0.05, at = halfdecaydist, cex = 0.75, col = "green")
dev.off()
>>>>>>> 77952f27f31daee9d67d0cfb5a78e3ffe636aeba
